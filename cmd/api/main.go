...
func main() {
	...
	// Declare a new serve mux and add a /v1/healthcheck route which dispatches requests
	...
	// uses the serve mux we created above as the handler, has some sensible timeout
